...
const card: Battlecard = {
  ...
  companyOverview: { companyIntroduction: { text: "企业公开发布海外渠道协同计划。", sourceIds: [sourceId] }, productsAndServices: [{ text: "渠道协同服务。", sourceIds: [sourceId] }], industryAndCoverage: { text: "公开资料体现其服务海外渠道市场。", sourceIds: [sourceId] }, recentUpdates: [{ text: "近期发布渠道协同计划。", sourceIds: [sourceId] }] },
  companyAnalysis: { businessModel: { text: "公开资料不足以确认收入结构。", sourceIds: [sourceId] }, productPositioning: { text: "面向渠道协同场景。", sourceIds: [sourceId] }, targetCustomers: { text: "服务渠道伙伴和相关团队。", sourceIds: [sourceId] }, competitionObservation: { text: "公开资料不足以判断直接竞争。", sourceIds: [sourceId] }, painHypotheses: [{ text: "待验证：渠道信息可能需要统一。", businessImpact: "可能影响响应效率。", confidenceLabel: "低", validationQuestion: "目前最难协同的环节是什么？", sourceIds: [sourceId] }] },
  salesStrategy: { entryPoints: [{ text: "从渠道协同计划切入。", sourceIds: [sourceId] }], recommendation: { text: "用产品协助统一公开信号。", sourceIds: [sourceId] }, opening: { text: "我看到公开渠道计划。", sourceIds: [sourceId] }, potentialNeeds: [{ text: "待验证：需要统一渠道信息。", sourceIds: [sourceId] }], discoveryQuestions: [{ question: "当前阻碍是什么？", purpose: "确认痛点。" }, { question: "影响什么指标？", purpose: "量化影响。" }, { question: "谁参与决策？", purpose: "了解决策。" }], recommendedNextStep: "约一次需求交流。", avoid: ["不要将推断当作事实。"] },
